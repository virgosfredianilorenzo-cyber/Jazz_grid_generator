...
- 🎼 **Annotations de théorie musicale** par accord :
  - Modes compatibles avec diagramme de manche SVG dynamique (21 modes, basse 4 et 5 cordes EADG / BEADG)
...
### Modes proposés par qualité d'accord
...
| `dim7` | Diminué ton-demi, Diminué demi-ton |
| `mM7` | Mélodie mineure, Lydien augmenté, Min. harmonique |
| `aug` | Tons entiers |

### Diagrammes de manche (basse 4 et 5 cordes)

21 diagrammes SVG intégrés, disponibles en **4 cordes EADG** et **5 cordes BEADG**, transposés dynamiquement selon la fondamentale de l'accord. Code couleur des points :
...
Liste complète des modes avec diagrammes :

| Mode | 4 cordes | 5 cordes | Qualité principale |
|------|----------|----------|--------------------|
| Ionien | ✅ | — | `maj7` |
| Dorien | ✅ | — | `m7` |
| Phrygien | ✅ | — | `m7` |
...
| Locrien #2 | ✅ | ✅ | `m7b5` |
| Tons entiers | ✅ | ✅ | `aug` |
| Min. harmonique | ✅ | ✅ | `mM7`, `m7` |
| Lydien augmenté | ✅ | ✅ | `maj7`, `mM7` |
...
| L672 | `JS — SVG DIAGRAMS` | Diagrammes de modes (manche de basse 4 et 5 cordes) |
...
### Ajouter un mode avec diagramme

1. Ajouter le mode dans `MODES_DEF` (section `JS — THEORY ENGINE`)
2. Créer le SVG du diagramme et l'ajouter dans `MODE_SVGS` (section `JS — SVG DIAGRAMS`)
3. Ajouter le mapping nom → clé SVG dans `MODE_NAME_TO_SVG`
4. Optionnel : créer une variante 5 cordes avec la clé `NomMode_5`
...
- Les **diagrammes de manche** donnent une référence visuelle immédiate au pupitre, en version **4 cordes EADG** et **5 cordes BEADG**
...
### 4.7
- ✨ **Diagrammes basse 5 cordes (BEADG)** — variantes 5 cordes pour 5 modes : Locrien #2, Tons entiers, Mixolydien b9b13, Min. harmonique, Lydien augmenté
- ✨ **Nouveaux modes** — Locrien #2, Tons entiers, Mixolydien b9b13, Min. harmonique et Lydien augmenté ajoutés avec diagrammes 4 et 5 cordes
- ✨ **Mineur harmonique** — ajouté dans `MODES_DEF` pour les qualités `mM7` et `m7`
- ✨ **Lydien augmenté** — ajouté dans `MODES_DEF` pour les qualités `maj7` et `mM7`
...
- [x] Diagrammes de manche SVG (basse 4 cordes, 17 modes)
- [x] Diagrammes de manche SVG basse 5 cordes (BEADG) — 5 modes
...
- [x] Mineur harmonique dans MODES_DEF
- [x] Lydien augmenté dans MODES_DEF
- [ ] Diagrammes 5 cordes pour tous les modes restants
...
Chaque contribution, même modeste, aide à financer le temps passé à développer de nouvelles fonctionnalités (diagrammes 5 cordes complets, undo/redo, import iReal Pro…).
